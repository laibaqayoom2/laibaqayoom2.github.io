...
export const Home = () => {
  return (
    ...
    >
      ...
      <RevealOnScroll>
        <div className="text-center z-10 px-4 relative max-w-6xl mx-auto">
          {/* Greeting Badge */}
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-6 leading-tight">
            ...
            <span className="inline-block bg-gradient-to-r from-blue-400 via-cyan-400 to-teal-400 bg-clip-text text-transparent hover:scale-105 transition-transform duration-300">
              Laiba Qayoom
            </span>
          </h1>
          ...
          {/* Description */}
          <p className="text-gray-300 text-base md:text-lg mb-12 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto">
            <div className="group cursor-default">
              <div className="bg-blue-500/10 border border-blue-500/30 rounded-2xl p-6 hover:border-blue-400/50 hover:bg-blue-500/15 transition-all duration-300 hover:-translate-y-1">
                <div className="text-4xl font-bold bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent mb-2">3+</div>
                <div className="text-sm text-gray-400 font-medium">Years Experience</div>
              </div>
            </div>
            
            <div className="group cursor-default">
              <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-2xl p-6 hover:border-cyan-400/50 hover:bg-cyan-500/15 transition-all duration-300 hover:-translate-y-1">
                <div className="text-4xl font-bold bg-gradient-to-r from-cyan-400 to-teal-400 bg-clip-text text-transparent mb-2">20+</div>
                <div className="text-sm text-gray-400 font-medium">Projects Done</div>
              </div>
            </div>
            
            <div className="group cursor-default">
              <div className="bg-purple-500/10 border border-purple-500/30 rounded-2xl p-6 hover:border-purple-400/50 hover:bg-purple-500/15 transition-all duration-300 hover:-translate-y-1">
                <div className="text-4xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent mb-2">3.81</div>
